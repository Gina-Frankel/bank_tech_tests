...
describe Transaction  do
  ...
  #   transaction = Transaction.new
  #   expect(transaction.record).to eq({ credit: nil, debit: nil, balance: '0.00', date: test_time })
  # end

  # it 'records the date when recording a transaction' do
  #   transaction_recorder = Transaction.new 
  ...
  #   transaction_recorder = Transaction.new(balance: 500)
  ...
  #   transaction_recorder = Transaction.new(balance: 300)
